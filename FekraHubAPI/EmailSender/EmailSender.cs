  ...
  <style type=""text/css"">
    ...
    @media only screen and (max-width:600px) {
      ...
      *[class=""gmail-fix""] {
      ...
      .es-text-4746 .es-text-mobile-size-14,
      .es-text-4746 .es-text-mobile-size-14 * {
        font-size: 14px !important;
        line-height: 150% !important
      }

      .es-text-9171 .es-text-mobile-size-26,
      .es-text-9171 .es-text-mobile-size-26 * {
        font-size: 26px !important;
        line-height: 150% !important
      }

      .es-text-5335 .es-text-mobile-size-10.es-override-size,
      .es-text-5335 .es-text-mobile-size-10.es-override-size * {
        font-size: 10px !important;
        line-height: 150% !important
      }

      .es-text-5335 .es-text-mobile-size-12.es-override-size,
      .es-text-5335 .es-text-mobile-size-12.es-override-size * {
        font-size: 12px !important;
        line-height: 150% !important
      }

      .es-text-5335 .es-text-mobile-size-14.es-override-size,
      .es-text-5335 .es-text-mobile-size-14.es-override-size * {
        font-size: 14px !important;
        line-height: 150% !important
      }

      .es-text-9623 .es-text-mobile-size-14.es-override-size,
      .es-text-9623 .es-text-mobile-size-14.es-override-size * {
        font-size: 14px !important;
        line-height: 150% !important
      }
...
<td style=""height:20px;""></td>
          ...
          <table cellpadding=""0"" cellspacing=""0"" class=""es-header es-desk-hidden hiddenHeader"" role=""none""
            style=""display:none;overflow:hidden;width:100%;max-height:0;line-height:0;mso-hide:all;mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;table-layout:fixed !important;background-color:transparent;background-repeat:repeat;background-position:center top"">
            <tr>
            ...
            <tr>
              <td align=""center"" style=""padding:0;Margin:0"">
                <table bgcolor=""#ffffff"" align=""center"" cellpadding=""0"" cellspacing=""0"" class=""es-content-body""
                  ...
                  <tr>
                    <td align=""left""
                      style=""Margin:0;padding-right:20px;padding-left:20px;padding-top:30px;padding-bottom:10px"">
             ...
             style=""display:inline-block; border:0; outline:none; text-decoration:none;"">
                                      ...
                                      <td align=""center"" valign=""top"" width=""33.333%""
                                        ...
                                        <p
                                          style=""Margin:0;font-family:arial,'helvetica neue',helvetica,sans-serif;font-size:16px;line-height:1.6;"">
                                          Schulungsräume :<br>
                                          Kleiststraße 23&nbsp;-&nbsp;26, 10787 Berlin (6.OG)<br><br>
                                          Postanschrift :<br>
                                          Sophie-Charlotten-Straße 90, 14059 Berlin
                                        </p>
                                      </td>
                                    </tr>
                                  </table>
                              ...
                              <tr>
                                <td align=""center"" class=""es-text-4746"" style=""padding:0;Margin:0;padding-bottom:10px;"">
                                  <p class=""es-text-mobile-size-14""
                                    ...
                                    © 2025 <a target=""_blank"" href=""https://netwitcher.com""
                                      style=""mso-line-height-rule:exactly;text-decoration:none;color:#333333;font-size:14px;line-height:21px"">netwitcher</a>.
                                    Alle Rechte vorbehalten.</p>
                                </td>
                              </tr>
                            </table>
...
<p class=""es-text-mobile-size-14 es-override-size"" style=""Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px;white-space:nowrap""><strong>Familieninformationen :</strong></p>
                              <ul style=""font-family:arial, 'helvetica neue', helvetica, sans-serif;padding:0px 0px 0px 40px;margin:15px 0px;white-space:nowrap"">
                               ...
                               <li style=""color:#333333;margin:0px 0px 15px;font-size:14px""><p class=""es-text-mobile-size-14 es-override-size"" style=""Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px"">Straße :{user.Street}</p></li>
                               <li style=""color:#333333;margin:0px 0px 15px;font-size:14px""><p class=""es-text-mobile-size-14 es-override-size"" style=""Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px"">NR :{user.StreetNr}</p></li>
...
<p class=""es-text-mobile-size-14 es-override-size"" style=""Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px;white-space:nowrap""><strong>student information :</strong></p>
                              <ul style=""font-family:arial, 'helvetica neue', helvetica, sans-serif;padding:0px 0px 0px 40px;margin:15px 0px;white-space:nowrap"">
                               ...
                               <li style=""color:#333333;margin:0px 0px 15px;font-size:14px""><p class=""es-text-mobile-size-14 es-override-size"" style=""Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px"">Straße :{student.Street}</p></li>
                               <li style=""color:#333333;margin:0px 0px 15px;font-size:14px""><p class=""es-text-mobile-size-14 es-override-size"" style=""Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px"">NR :{student.StreetNr}</p></li>
...
";
            ...
            await _notificationsRepo.Add(newNotification);
            List<NotificationUser> notificationUsers = new List<NotificationUser>();
            foreach (var user in Secretaries)
            {
                var notificationUser = new NotificationUser
                {
                    NotificationId = newNotification.Id,
